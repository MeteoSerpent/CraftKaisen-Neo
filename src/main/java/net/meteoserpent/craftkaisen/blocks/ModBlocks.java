...
public class ModBlocks {
    ...
    public static final DeferredBlock<Block> SUKUNA_FINGER = registerBlock("sukuna_finger",
            () -> new SukunaFingerBlock(BlockBehaviour.Properties.of().sound(SoundType.FUNGUS).noOcclusion().noCollission()));
    public static final DeferredBlock<Block> CURSED_TECHNIQUE_CRAFTER = registerBlock("cursed_technique_crafter",
            ...
            () -> new CursedTechniqueCrafterBlock(BlockBehaviour.Properties.of().sound(SoundType.STONE).noOcclusion()));
    ...
    private static <T extends Block> void registerSukunaItem(String name, DeferredBlock<T> block) {
        ModItems.ITEMS.register(name, () -> new BlockItem(block.get(), new Item.Properties().food(ModFoodProperties.SUKUNA_FINGER)) {
            @Override
